...
export default function Card({ img, title, description, likes }: CardProps) {
  return (
    <article className="border border-border inline-flex flex-col bg-white cursor-pointer group/card hover:shadow hover:-translate-y-1 transition-all duration-250">
