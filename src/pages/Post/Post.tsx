    ...
    <>
      <div className="sticky top-16 left-0 right-0 bg-background border-b border-border px-4 py-2">
        <div className="flex justify-between max-w-270 mx-auto">
          <NavLink
            to={'/'}
            className="text-muted-foreground hover:text-foreground transition-colors duration-200 text-[clamp(14px,2vw,16px)] flex items-center gap-2"
          >
            <IoIosArrowBack className="text-sm transition-colors duration-200" />
            All articles
          </NavLink>
