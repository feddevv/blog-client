        ...
        <div className="flex items-start gap-3.5">
          {post.thumbnailUrl ? (
            <img
              ...
              alt=""
              className="w-12 h-12 object-cover rounded-xs border border-border shrink-0 bg-muted hidden sm:block"
            />
          ) : (
            <div className="w-12 h-12 rounded-xs border border-border bg-secondary flex items-center justify-center shrink-0 hidden sm:flex text-muted-foreground">
